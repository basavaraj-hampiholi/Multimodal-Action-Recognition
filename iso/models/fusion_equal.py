...
class TransFusion(nn.Module):
    def __init__(self, i3d_rgb, i3d_flow, class_nb=101):
        ...
        self.rgb_l1 = nn.Sequential(i3d_rgb.Mixed_3b, i3d_rgb.Mixed_3c, i3d_rgb.MaxPool3d_4a_3x3, i3d_rgb.Mixed_4b)
        self.rgb_l2 = nn.Sequential(i3d_rgb.Mixed_4c, i3d_rgb.Mixed_4d, i3d_rgb.Mixed_4e)
        self.rgb_l3 = nn.Sequential(i3d_rgb.Mixed_4f, i3d_rgb.MaxPool3d_5a_2x2, i3d_rgb.Mixed_5b, i3d_rgb.Mixed_5c)
        self.rgb_logits = i3d_rgb.logits

        self.flow_l1 = nn.Sequential(i3d_flow.Mixed_3b, i3d_flow.Mixed_3c, i3d_flow.MaxPool3d_4a_3x3, i3d_flow.Mixed_4b)
        self.flow_l2 = nn.Sequential(i3d_flow.Mixed_4c, i3d_flow.Mixed_4d, i3d_flow.Mixed_4e)
        self.flow_l3 = nn.Sequential(i3d_flow.Mixed_4f, i3d_flow.MaxPool3d_5a_2x2, i3d_flow.Mixed_5b, i3d_flow.Mixed_5c)
