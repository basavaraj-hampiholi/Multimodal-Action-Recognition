...
from models.fusion_squeeze import TransFusion
...
def load_weights(path, type):
    if type=='rgb':
        mv2 = SqueezeNet(sample_size=224, sample_duration=64, version=1.1, num_classes=600)
...
def main():
    ...
    best_prec1=0
    i3d_rgb = load_weights('save_model/nv_rgb_squeeze_best.pt', 'rgb')
    i3d_flow = load_weights('save_model/nv_depth_squeeze_best.pt', 'depth')
