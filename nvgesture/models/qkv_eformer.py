...
class DepthwiseConv(nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        self.depthwise = nn.Conv3d(in_channels//self.ratio, in_channels//self.ratio, kernel_size=(3,3,3), padding=(1,1,1), groups=in_channels//self.ratio)
...
class EfficientAttention(nn.Module):   
    ...
    def forward(self, input_rgb, input_flow):
        fused_input = input_rgb+input_flow
        ...
        keys = rgb_keys+flow_keys
        queries = rgb_queries+flow_queries
        values = rgb_values+flow_values
