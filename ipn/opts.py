...
def parse_opts_online():
    ...
    parser.add_argument('--resize', default=256, type=int, help='Height and width of inputs')
    ...
    parser.add_argument('--lr_steps', default=[15, 25], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
